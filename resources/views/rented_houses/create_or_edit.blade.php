            ...
            <form role="form">
                ...
                <div class="box box-default">
                    ...
                    <div class="form-group">
                            ...
                            <label class="item_label">
                                <input type="radio" class="table-radio minimal" @if (!empty($house->region_index) && in_array('middle', $house->region_index)) checked @endif name="region_index[]" value="middle">&nbsp;&nbsp;中部
                            </label>
                            <label class="item_label">

            ...
            <form role="form">
                ...
                <div class="box box-default">
                    ...
                    <div class="form-group">
                            ...
                            <label class="item_label">
                                <input type="radio" class="table-radio minimal" @if (!empty($house->region_index) && in_array('middel', $house->region_index)) checked @endif name="region_index[]" value="middel">&nbsp;&nbsp;中部
                            </label>
                            <label class="item_label">
...
<script type="text/javascript">
  ...
  $(".add_image").click(function() {
    ...
    $(document).ready(function(){
            ...
            initEditor('textarea[name=surrounding_facilities]');
